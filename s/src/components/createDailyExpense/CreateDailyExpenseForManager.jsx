...
const CreateDailyExpenseForManager = ({ companies }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    await axios
      .post(
        `https://api.alistudiox.com/public/api/v1/add-cost?day=${date}&note=${note}&amount=${price}`,
        newDailyService,
        {
          headers: {
...
export default CreateDailyExpenseForManager;
