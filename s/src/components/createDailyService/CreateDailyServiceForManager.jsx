...
const CreateDailyServiceForManager = ({getDailyStatisticsOfCompanyByDate}) => {
  ...
  const handleSubmit = async (e) => {
    ...
    await axios
      .post(
        `https://api.alistudiox.com/public/api/v1/add-daily-services?first_name=${nameValue}&last_name=${lastNameValue}&phone_number=${phoneNumValue}&age=${age}&day=${date}&time=${time}&price=${price}&service_id=${service_id}&note=${note}`,
        newDailyService,
        {
          headers: {
...
export default CreateDailyServiceForManager;
